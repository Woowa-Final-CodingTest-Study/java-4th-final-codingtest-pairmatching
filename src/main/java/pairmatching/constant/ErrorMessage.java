...
public class ErrorMessage {
    ...
    public static final String INPUT_NULL = PREFIX + "입력값을 확인해주세요.";
    public static final String INPUT_OPTION_VALUE = PREFIX + "1, 2, 3, Q만 입력해주세요";
    public static final String INPUT_CORRECT_SEPARATOR = PREFIX + "쉼표(,)를 사용하여 입력해주세요.";
